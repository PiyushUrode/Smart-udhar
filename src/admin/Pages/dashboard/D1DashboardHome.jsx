...
import useDashboardController from "../../controller/Dashboard/DashboardCTR";
...
const D1DashboardHome = () => {
  ...
  if (loading) {
    return <div className="p-4 pt-10 text-center text-gray-500">Loading dashboard...</div>;
  }

  if (error) {
    return <div className="p-4 pt-10 text-center text-red-500">{error}</div>;
  }
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <StatCard
            ...
            isPositive={stats.pendingSumChange < 0}
            type="pending"
          />
