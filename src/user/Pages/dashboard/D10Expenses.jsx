      ...
      <div className="max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6 border rounded-lg shadow-lg bg-white">
        ...
        <div className="bg-white rounded-xl shadow-md p-8 lg:col-span-2">
          ...
          >
            ...
            {/* Payment Mode */}
            <div>
              <label className="font-medium mb-3 block">Payment Mode</label>
              <div className="flex gap-6 mt-1">
                {paymentModes.map((mode) => (
                  <label key={mode} className="flex items-center gap-2">
                    <input
                      type="radio"
                      className="checked:bg-blue-500 checked:text-white appearance-none h-5 w-5 border-2 rounded-full border-gray-700 rounded-sm checked:bg-white checked:border-black checked:after:content-['✔'] checked:after:text-blue-500 checked:after:block checked:after:text-center"
                      name="paymentMode"
                      value={mode}
        ...
        <div className="bg-white rounded-xl shadow-md p-6  space-y-6">
          ...
          <div className="flex flex-row justify-between items-center bg-[#EFF6FF] py-4 px-3 gap-4">
            <div className="flex flex-col ">
              {" "}
              <p className="text-sm text-[#2563EB]">Total Monthly Expense</p>
              {/* <p className="text-2xl font-bold text-[#1E40AF]">₹45,230</p> */}
              <p className="text-2xl font-bold text-[#1E40AF]">
                ₹{summary.total}
              </p>
            </div>
            <div className="p-1 border-dotted border-4 rounded-full border-[#3B82F6] ">
              {" "}
              <FaQuestion color="#3B82F6" />
            </div>
          </div>
          ...
          <div className="flex flex-row justify-between items-center bg-[#F0FDF4] border-[#E5E7EB] border py-4 px-3 gap-4">
            <div className="flex flex-col ">
              {" "}
              <p className="text-sm text-[#16A34A]">GST Credit Available</p>
              {/* <p className="text-2xl font-bold text-[#166534]">₹8,142 </p> */}
              <p className="text-2xl font-bold text-[#166534]">
                ₹{summary.gstCredit.toFixed(2)}
              </p>
            </div>
            <div className="p-1  ">
              {" "}
              <FaPercentage color="#22C55E" />
            </div>
          </div>
              ...
              {Object.entries(summary.categories).map(([cat, amt], index) => {
                ...
                return (
                  <li key={cat} className="flex justify-between items-center">
                    ...
                    <span className="font-interM text-[#1F2937] leading-4">
                      ₹{amt}
                    </span>
                  </li>
                );
