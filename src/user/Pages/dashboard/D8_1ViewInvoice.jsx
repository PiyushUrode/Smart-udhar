    ...
    <div className="max-w-screen-xl mx-auto p-2 sm:p-4 overflow-x-auto">
      <div className="min-w-[900px] mx-auto">
        ...
        >
          ...
          <div className="flex justify-between">
            <div className="border h-[200px] w-[40%] mt-6">
              <p className="text-center mt-2 font-bold text-base mb-1 text-gray-700">Vendor Sign</p>
            </div>
            <div className="border h-[200px] w-[40%] mt-6">
              <p className="text-center mt-2 font-bold text-base mb-1 text-gray-700">Customer Sign</p>
            </div>
          </div>
