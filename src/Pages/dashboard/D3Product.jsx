...
const ProductForm = ({ formData, handleChange, handleSubmit, showAdvanced, setShowAdvanced }) => (
...
const ServiceForm = ({ formData, handleChange, handleSubmit, showAdvanced, setShowAdvanced }) => (
...
export default function D3Product() {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-5 md:mt-10 pb-7 bg-white rounded-lg shadow-customCard">
      {/* Blue Header */}
      <div className="bg-bluecol text-white px-6 py-3 rounded-t-md text-lg font-semibold">Items</div>
        ...
        {["product", "service"].map((tab) => (
          <button
            ...
            className={`pb-2 text-lg font-medium border-b-2 ${
              activeTab === tab ? "border-bluecol text-bluecol" : "border-transparent text-gray-500"
            }`}
          >
